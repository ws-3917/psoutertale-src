...
const keys = {
   downKey: CosmosKeyboardInput.create('ArrowDown', 'KeyS'),
   freecamKey: CosmosKeyboardInput.create('Tab'),
   interactKey: CosmosKeyboardInput.create('Enter', 'Space'),
   leftKey: CosmosKeyboardInput.create('ArrowLeft', 'KeyA'),
   rightKey: CosmosKeyboardInput.create('ArrowRight', 'KeyD'),
   specialKey: CosmosKeyboardInput.create('Backspace', 'Escape', 'ShiftLeft', 'ShiftRight'),
   upKey: CosmosKeyboardInput.create('ArrowUp', 'KeyW')
};
