import { helmetdyne } from '../common/extras';
import { content } from '../systems/assets';
import { world } from '../systems/framework';
import { SAVE } from '../systems/save';
import { CosmosInventory } from '../systems/storyteller';
...
export function undyneMusicAssets() {
    if (world.genocide) {
        return new CosmosInventory(content.amUndynegeno, content.amUndynegenoStart);
    } else if (helmetdyne()) {
        return new CosmosInventory(content.amUndynehelmet);
    } else {
        return new CosmosInventory(content.amUndyneboss);
    }
}
