                ...
                tweetSprite: new CosmosSprite({
                    ...
                    objects: [
                        new CosmosText({
                            ...
                            this.content = text.b_opponent_woshua.tweet;
                        })
                    ]
                })
            },
            ...
            switch (choice.type) {
                ...
                case 'fight': {
                    if (world.genocide) {
                        ...
                        if (gannadie) {
                            if (vars.phase < 5) {
                                groups.undyne.assets.unload();
                                groups.undyne.assets = new CosmosInventory(content.amEndingexcerpt);
                                const endingLoader = groups.undyne.assets.load();
                                const c = vars.c;
                                ...
                                await Promise.all([endingLoader, renderer.pause(1000)]);
