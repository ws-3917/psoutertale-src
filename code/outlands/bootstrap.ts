...
phone.register('toriel', {
    ...
    async trigger() {
        ...
        if (world.genocide && (world.goatbro || (game.room === 'w_exit' && SAVE.data.n.plot < 16))) {
            quickCall(
                false,
                ...commonText.c_call_common.nobody1,
                ...CosmosUtils.provide(text.c_call_toriel_extra.c_call_asriel)
            );
            return;
            ...
            quickCall(false, ...CosmosUtils.provide(text.c_call_toriel_extra.c_call_toriel_early));
            return;
            ...
            quickCall(false, ...CosmosUtils.provide(text.c_call_toriel_extra.c_call_toriel_late)).then(() => {
