...
export const game = {
    ...
    resize() {
        ...
        game.ratio = Math.min(frame.clientWidth / game.framewidth, frame.clientHeight / game.frameheight);
        wrapper.style.width = `${game.width}px`;
        wrapper.style.height = `${game.height}px`;
        borderContainer.style.transform = `scale(${game.ratio})`;
    },
    /** current room */
    room: '',
    /** player can sprint */
...
export const keys = {
    ...
    downKey: CosmosKeyboardInput.create('ArrowDown', 'KeyS', 'Numpad5'),
    interactKey: CosmosKeyboardInput.create('KeyZ', 'Enter', 'Numpad1'),
    leftKey: CosmosKeyboardInput.create('ArrowLeft', 'KeyA', 'Numpad4'),
    menuKey: CosmosKeyboardInput.create('KeyC', 'ControlLeft', 'ControlRight', 'Numpad3'),
    quitKey: CosmosKeyboardInput.create('Escape'),
    rightKey: CosmosKeyboardInput.create('ArrowRight', 'KeyD', 'Numpad6'),
    shiftKey: CosmosKeyboardInput.create('ShiftLeft', 'ShiftRight'),
    specialKey: CosmosKeyboardInput.create('KeyX', 'ShiftLeft', 'ShiftRight', 'Numpad2'),
    upKey: CosmosKeyboardInput.create('ArrowUp', 'KeyW', 'Numpad8')
};
