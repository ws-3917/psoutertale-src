                            ...
                            if (royals === 1) {
                                ...
                                if (!ddoggo) {
                                    ...
                                    addB([
                                        ...
                                        "<25>{#p/sans}{#f/3}* hát... ha ez bármennyire is vigasztal...",
                                        '<25>{#p/sans}{#f/0}* szerintem helyesen cselekedtél.'
                                    ]);
                                } else if (!ddogs) {
                                    addB([
                                        '<18>{#p/papyrus}{#f/5}HANGOS KOPOGÁST HALLOK A SZERVIZ AJTÓN.',
                                        '<18>{#p/papyrus}{#f/6}KÉPZELD, KÉT KUTYA BALTÁKKAL ZÖRGETTE!',
                                        '<18>{#p/papyrus}{#f/5}AZ ELEJÉN MEGIJEDTEM...',
                                        '<18>{#p/papyrus}{#f/5}DE MIUTÁN ELMONDTÁK...',
                                        '<18>{#p/papyrus}{#f/5}AZ ÉRZÉSEM SZOMORBA HAJLOTT.',
                                        '<18>{#p/papyrus}{#f/3}... AZ ÖSSZES KIRÁLYI GÁRDATAG...',
                                        '<18>{#p/papyrus}{#f/31}...',
                                        '<18>{#p/papyrus}{#f/5}DOGAMY ÉS DOGARESSA...',
                                        '<18>{#p/papyrus}{#f/5}NEM VOLTAK BIZTOSAK BENNE, HOGY HÁZASSÁGUK FENNTARTHATÓ-E.',
                                        '<25>{#p/sans}{#f/0}* hmm...',
                                        '<25>{#p/sans}{#f/3}* ... biztosan rávetted őket, hogy maradjanak együtt.',
                                        '<18>{#p/papyrus}{#f/4}...',
                                        '<18>{#p/papyrus}{#f/4}TÚL JÓL ISMERSZ.',
                                        '<18>{#p/papyrus}{#f/5}MINDEGY IS, CSAK EGY KIS MAGÁNYRA VOLT SZÜKSÉGÜK EZUTÁN.',
                                        "<18>{#p/papyrus}{#f/5}SZÓVAL... ASGORE HÁZÁNÁL HAGYTAM ŐKET.",
                                        '<25>{#p/sans}{#f/0}* úgy hallottam, még mindig ott élnek.',
                                        '<25>{#p/sans}{#f/2}* valami azt súgja, az extra szoba jól fög jönni nemsoká.'
                                    ]);
                                } else if (!dgreatdog) {
                                    addB([
                                        '<18>{#p/papyrus}{#f/5}VALAMI KOPOGÁST HALLOK A SZERVIZ AJTÓTÓL.',
                                        "<18>{#p/papyrus}{#f/6}KIDERÜLT, HOGY EGY NAGY KUTYA UGATÁSA VOLT.",
                                        '<18>{#p/papyrus}{#f/5}MAJD A KUTYA LEVETTE PÁNCÉLJÁT ÉS PICI LETT.',
                                        '<18>{#p/papyrus}{#f/6}HOZZÁM SIETETT ÉS JÁTSZANI AKART!',
                                        '<18>{#p/papyrus}{#f/6}ELÉGGÉ... IZGATOTTNAK TŰNT.',
                                        "<18>{#p/papyrus}{#f/6}MINTHA SENKIVEL NEM JÁTSZOTT VOLNA ÉVEK ÓTA!",
                                        '<18>{#p/papyrus}{#f/4}ÉRTEM, HOGY A KUTYÁK TUDNAK FURÁK LENNI, DE...',
                                        '<18>{#p/papyrus}{#f/6}AZON AGYALTAM, VALAMI FÉLRECSÚSZHATOTT!',
                                        '<18>{#p/papyrus}{#f/5}MEGKÉRDEZTEM ALPHYST ÉÉS...',
                                        '<18>{#p/papyrus}{#f/5}ELMONDTA MI IS A SZITUÁCIÓ.',
                                        '<18>{#p/papyrus}{#f/3}... AZ ÖSSZES KIRÁLYI GÁRDATAG...',
                                        '<18>{#p/papyrus}{#f/31}...',
                                        '<18>{#p/papyrus}{#f/5}NEHÉZ VOLT EZEKET HALLANI, DE...',
                                        '<18>{#p/papyrus}{#f/6}TUDOM, HOGY ÉREZHETETT CANIS MAJOR...',
                                    ...
                                    addB([
                                        '<18>{#p/papyrus}{#f/5}FELHÍVOTT AZ EGYIK MAGAS RANGÚ GÁRDA TAG.',
                                        '<18>{#p/papyrus}{#f/6}ÉS KÖZÜLÜK AZ EGYIK LEGNAGYOBB.',
                                        "<18>{#p/papyrus}{#f/5}UNDYNE BARÁTJAKÉNT, MEGKÉRT, HOGY TALÁLKOZZUNK...",
                                        '<18>{#p/papyrus}{#f/6}HOGY ÁTBESZÉLJÜNK VALAMI \"NAGYON FONTOSAT.\"',
                                        '<18>{#p/papyrus}{#f/6}PICIT IDEGES VOLTAM AZ EGÉSZ MIATT...',
                                        '<18>{#p/papyrus}{#f/5}DE A TAG TÉNYLEG CSAK SZÓT AKART VÁLTANI.',
                                        '<18>{#p/papyrus}{#f/4}BEVALLOM, ELÉG REJTÉLYES VOLT...',
                                        '<18>{#p/papyrus}{#f/5}DE SZÉP LASSAN MEGFEJTETTEM A KÓDOT.',
                                        '<18>{#p/papyrus}{#f/3}... AZ ÖSSZES KIRÁLYI GÁRDATAG...',
                                        '<18>{#p/papyrus}{#f/31}...',
                                        '<18>{#p/papyrus}{#f/5}DOGE ELVESZTETTE ÉLETCÉLJÁT.',
                                        '<18>{#p/papyrus}{#f/6}AMI A SZÖRNYEK VÉDELME VOLT.',
                                        '<18>{#p/papyrus}{#f/5}HA A KIRÁLYI GÁRDÁT EGY EMBER KI TUDJA IRTANI...',
                                        '<18>{#p/papyrus}{#f/6}MIT TEHETNE EGYEDÜL?',
                                        '<18>{#p/papyrus}{#f/5}...\nELVITTEM A CITADELLÁHOZ.',
                                        '<18>{#p/papyrus}{#f/5}MEGMUTATTAM NEKI AZ EMBERI LELKEKET.',
                                        '<18>{#p/papyrus}{#f/6}MAJD AZT MONDTAM...',
                                        '<18>{#p/papyrus}{#f/6}\"MÁR CSAK EGY KELL.\"',
                                        '<18>{#p/papyrus}{#f/5}RÁMNÉZETT, BECSUKTA SZEMEIT...',
                                        '<18>{#p/papyrus}{#f/6}AZT VÁLASZOLTA \"ÉRTEM.\"',
                                        '<25>{#p/sans}{#f/0}* jesszus.\n* intenzíven hangzik.',
                                        "<25>{#p/sans}{#f/3}* a szavak ereje biztosan motiválta kicsit."
                                    ]);
                                } else if (!droyalguards) {
                                    addB([
                                        '<18>{#p/papyrus}{#f/5}KÉT SZÁMOZOTT GÁRDATAG FELHÍVOTT.',
                                        '<18>{#p/papyrus}{#f/6}ÉS KÖZÜLÜK AZ EGYIK LEGNAGYOBB.',
                                        '<18>{#p/papyrus}{#f/5}ÉS MIVEL FAGYIZGATUNK NÉHA EGYÜTT...',
                                        '<18>{#p/papyrus}{#f/6}MEGKÉRTEK, HOGY TALÁLKOZZUNK, HOGY MEGBESZÉLJÜNK VALAMIT.',
                                        '<25>{#p/sans}{#f/0}* ha ki kéne találnom...',
                                        "<25>{#p/sans}{#f/3}* a találka nem a fagyiról szólt.",
                                        '<18>{#p/papyrus}{#f/6}SAJNOS NEM.',
                                        '<18>{#p/papyrus}{#f/5}CSAK... ROSSZ HÍREKKEL SZOLGÁLTAK.',
                                        '<18>{#p/papyrus}{#f/3}... AZ ÖSSZES KIRÁLYI GÁRDATAG...',
                                        '<18>{#p/papyrus}{#f/31}...',
                                        '<18>{#p/papyrus}{#f/5}ÉPPHOGY FELJEBB LÉPTEK A RANGLÉTRÁN...',
                                        '<18>{#p/papyrus}{#f/6}ÚGY ÉREZTÉK A KIKÉPZÉSÜK NEM ÉRT SEMMIT.',
                                        '<18>{#p/papyrus}{#f/6}BUT...!\nFELAJÁNLOTTAM, HOGY KERESHETÜNK ÚJ MUNKÁT!!',
                                        '<18>{#p/papyrus}{#f/5}SZÓVAL FELHOZTAM PÁR ÖTLETET.',
                                        '<18>{#p/papyrus}{#f/4}A LEGTÖBBET ELVETETTÉK, DE...',
                                        '<18>{#p/papyrus}{#f/4}IMÁDTÁK AZ ÚSZÓCSAPATBA LÉPÉS GONDOLATÁT.',
                                        "<25>{#p/sans}{#f/0}* szóval asz'ondod, hogy 01 és 02 profi úszók lettek?",
                                        "<25>{#p/sans}{#f/3}* végülis, amég boldogok, addig nincs gond.",
                                        "<18>{#p/papyrus}{#f/4}OH, NE AGGÓDJ.\nNEMCSAK, HOGY BOLDOGOK...",
                                        "<18>{#p/papyrus}{#f/0}IGENCSAK HÍRESEK LETTEK!",
                                        "<18>{#p/papyrus}{#f/5}...\nDE, MIVEL TUDOM, MIÉRT KERÜLTEK ODA...",
                                        '<18>{#p/papyrus}{#f/5}PICIT ELSZOMORÍT.'
                                    ]);
                                } else if (!dmadjick) {
                                    addB([
                                        '<18>{#p/papyrus}{#f/5}VALAMI FURA MÁGUS JELENIK MEG A SZERVIZ SZOBÁBAN.',
                                        '<18>{#p/papyrus}{#f/6}ÉS AZT KÉRDEZTE, MI AZ ÉLET ÉRTELME.',
