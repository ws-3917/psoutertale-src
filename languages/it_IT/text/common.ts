...
export default {
    ...
    a_common: {
        ...
        lastblook1: [
            ...
            () => [
                ...
                choicer.create('* (Lay down next to it?)', 'Sì', 'No')
            ],
            () => ['<32>{#p/basic}* The ghost is still here.', choicer.create('* (Lay down next to it?)', 'Sì', 'No')]
        ],
        ...
        view: () => [choicer.create('* (Are you ready to go outside?)', 'Sì', 'No')],
        computer1: () =>
            SAVE.data.b.ufokinwotm8
        ...
        computer2: () => [choicer.create('* (Insert the Computer Chip?)', 'Sì', 'No')],
    ...
    b_party_kidd: {
        ...
        mkTurnFight1: () => [
            ...
            choicer.create('* (Do you confirm?)', 'Sì', 'No')
        ],
