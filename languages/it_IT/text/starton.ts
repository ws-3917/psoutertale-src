...
export default {
    a_starton: {
        telescope1: () => [
            ...
            choicer.create('* (Use the telescope?)', 'Sì', 'No')
        ],
        ...
        emptytable2: () =>
            SAVE.data.b.svr
                ? ['<32>{#p/human}* (The table strikes you as being rather lonesome.)']
                : ["<32>{#p/basic}* It's just a lonely table.\n* Smells like hair."],
        balcony0: () => ['<18>{#p/papyrus}ENJOYING THE VIEW?', choicer.create('* (What do you say?)', 'Sì', 'No')],
        balcony1: [
        ...
        bedbook4: () => [choicer.create('* (Have $(name) read the book?)', 'Sì', 'No')],
        bedbook5: [
        ...
        candy1: () =>
            postSIGMA()
                ...
                : [
                    ...
                    choicer.create('* (Buy the Exoberries for 8G?)', 'Sì', 'No')
                ],
        ...
        innkeep1a: pager.create(
            ...
            () => [
                ...
                choicer.create('* (Get a room?)', 'Sì', 'No')
            ],
            () => [
        ...
        innkeep1b: pager.create(
            ...
            () => [
                ...
                choicer.create('* (Get a room again?)', 'Sì', 'No')
            ],
            () => ['<32>{#p/basic}{#npc/a}* Changed your mind?', choicer.create('* (Get a room again?)', 'Sì', 'No')]
        ),
        ...
        nicecreamPrompt1: () => [choicer.create('* (Buy the Ice Dream for $(x)G?)', 'Sì', 'No')],
        nicecreamPrompt2: () => [choicer.create('* (Get an Ice Dream?)', 'Sì', 'No')],
        nicecreamSc4: [
            ...
            papmail1: () =>
                SAVE.data.b.svr
                    ...
                    : [
                        ...
                        choicer.create('* (Look inside the mailbox?)', 'Sì', 'No')
                    ],
            ...
            () =>
                postSIGMA()
                    ...
                    : [
                        ...
                        choicer.create("* (Log in to Papyrus's account?)", 'Sì', 'No')
                    ],
            () =>
                postSIGMA()
                    ? ["<32>{#p/basic}* It's out of service."]
        ...
        papcouch1: pager.create(
            ...
            () => [
                ...
                choicer.create('* (Take the coins?)', 'Sì', 'No')
            ],
            () => [
                SAVE.data.b.svr
        ...
        papdate4: pager.create(
            ...
            () => ['<18>{#p/papyrus}READY?', choicer.create('* (What do you say?)', 'Sì', 'No')]
        ),
        ...
        papdate5: pager.create(
            ...
            () => ['<18>{#p/papyrus}{#f/6}READY TO START?', choicer.create('* (What do you say?)', 'Sì', 'No')]
        ),
        papdate5a: () => [
            SAVE.data.b.flirt_papyrus
                ? '<18>{#p/papyrus}OKAY!!!\nDATING START!!!'
        ...
        papdate14: () => [choicer.create('* (What do you say?)', 'Sì', 'No')],
        ...
        papdate30: () => [choicer.create('* (Do you know what it is?)', 'Sì', 'No')],
        papdate31a: [
        ...
        puzzle3: () => [
            ...
            choicer.create('* (View the pattern?)', 'Sì', 'No')
        ],
        robotx: () =>
            SAVE.data.b.svr
        ...
        robot1: pager.create(
            ...
            () => [
                ...
                choicer.create('* (Take a chip?)', 'Sì', 'No')
            ],
            () => [
        ...
        robot6: () => [
            ...
            choicer.create('* (Take another chip?)', 'Sì', 'No')
        ],
        robot7: [
        ...
        sansbook2: () => [choicer.create('* (Take a look inside?)', 'Sì', 'No')],
