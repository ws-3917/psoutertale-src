...
export default {
    ...
    nameChoiceCameos: <CosmosKeyed<string>>{
        ...
        antsy: 'Possa la tranquillità invaderti mentre intraprendi il tuo viaggio.',
        ...
        nervy: 'Possa la tranquillità invaderti mentre intraprendi il tuo viaggio.',
        moody: 'Coraggio.\nLa storia è tua, non importa cosa credi.',
        ...
        minor: '(Pant pant)',
        papyrs: "TE LO CONCEDO!!!!",
        papyru: "TE LO CONCEDO!!!!",
        san: 'ok.',
        sans: 'eh no.',
        ...
        radtie: "Mi dispiace, ma ti manca una lettera.",
        radtil: "Mi dispiace, ma ti manca una lettera.",
        shyren: '...?',
        skrub: 'Nome pulito.',
        skrubb: 'Nome pulito.',
        tem: 'hOI!',
        ...
        catty: "Bratty! Bratty! Quello è il MIO nome!",
        cozmo: 'Un compagno mago?',
        glyde: 'Scelta astuta, bellezza.',
        hapsta: "Ora stai semplicemente essendo scortese, tesoro.",
        ...
        grillb: 'Caldo, ma non quanto me.',
        grilly: 'Caldo, ma non quanto me.',
        gyft: "Non devi farlo per forza...",
        heats: 'Lo SAPEVI!?',
