...
export default {
    a_starton: {
        ...
        papdate30: () => [choicer.create('* (Do you know what it is?)', 'Sim', 'Não')],
        papdate31a: [
        ...
        puzzle3: () => [
            ...
            choicer.create('* (View the pattern?)', 'Sim', 'Não')
        ],
        robotx: () =>
            SAVE.data.b.svr
        ...
        robot1: pager.create(
            ...
            () => [
                ...
                choicer.create('* (Take a chip?)', 'Sim', 'Não')
            ],
            () => [
        ...
        robot6: () => [
            ...
            choicer.create('* (Take another chip?)', 'Sim', 'Não')
        ],
        robot7: [
        ...
        sansbook2: () => [choicer.create('* (Take a look inside?)', 'Sim', 'Não')],
