...
export default {
    ...
    extra: {
        credits: [
            [
                '§fill=#ff0§< DESENVOLVEDOR >§fill=#fff§',
                'spacey_432',
                '',
            ...
            [
                ...
                'Zaxento The Greedy',
                '',
                '§fill=#ff0§< ARTISTA (CONTINUAÇÃO) >§fill=#fff§',
                'Abb',
            ...
            [
                ...
                'JustAnimates',
                '§fill=#808080§Melhorou a arte do sprite da Toriel.§fill=#fff§',
                'Kite95',
            ...
            [
                ...
                'Codetoil',
                '§fill=#808080§\"O Grande Físico Teórico Codetoil.\"§fill=#fff§',
                'Murder--Sans_MDR',
            ...
            [
                '§fill=#ff0§< TÉCNICO >§fill=#fff§',
                'ryi3r',
                '§fill=#808080§\"Lembra quando eu fiz speedrun da rota caótica?\"§fill=#fff§',
                'Wasneet Potato',
                ...
                '§fill=#808080§Adicionando a totalidade dos caracteres CJK em uma imagem... constrói caráter!§fill=#fff§',
            ],
            [
                '§fill=#ff0§< TESTE >§fill=#fff§',
                'Alden',
                'AnXing',
                'Aspey',
                'Aster',
