...
export default {
    a_foundry: {
        ...
        quicksolve6: () => ['<32>{#p/basic}* ...', choicer.create('* (Enter the code?)', 'Да', 'Нет')],
        ...
        blooktouch1: () =>
            world.sad_ghost
                ? [
                    ...
                    choicer.create('* (Что вы скажете?)', 'Sorry', 'Nothing')
                ]
                : [
                    '<32>{#p/napstablook}* oh, do you need anything?',
                    choicer.create('* (Что вы скажете?)', 'Hug', 'Sleep', 'Music', 'Nothing')
                ],
        blooktouch2a1: [
        ...
        blooktouch2c4: () => [
            ...
            choicer.create('* (Что вы скажете?)', 'Good', 'Bad')
        ],
        blooktouch2c5a: [
        ...
        npc86b: () => [
            ...
            choicer.create('* (Что вы скажете?)', 'Red', 'Green', 'Blue', 'Not sure')
        ],
        npc86c: [
        ...
        npc86d: () => [
            ...
            choicer.create('* (Что вы скажете?)', 'Good', 'Bad', 'Neutral', 'Not sure')
        ],
        npc86e: () => [
            ...[
        ...
        npc86f: () => [
            ...
            choicer.create('* (Что вы скажете?)', 'Love', 'Disgust', 'None', 'Not sure')
        ],
        npc86g: () =>
            [
                [
        ...
        spookydate1: pager.create(
            ...
            () => [
                ...
                choicer.create('* (Что вы скажете?)', 'Yeah', 'Nah')
            ],
            () => ["<25>{#p/sans}* my offer remains.\n* grillby's?", choicer.create('* (Что вы скажете?)', 'Yeah', 'Nah')]
        ),
        ...
        spookydate11: [
            ...
            choicer.create('* (Что вы скажете?)', "Flamin'\nGrillbys", '\nSliders'),
        ...
        spookydate13: () => [
            ...
            choicer.create('* (Что вы скажете?)', 'Easy', 'Hard')
        ],
        spookydate14a: [
            '<25>{#p/sans}* easy?\n* get outta here.',
        ...
        telescopeX: pager.create(
            ...
            () => ['<25>{#p/sans}{#f/2}* wanna try my telescope?', choicer.create('* (Что вы скажете?)', 'Да', 'Нет')]
        ),
        telescopeY: () =>
            SAVE.data.b.voucher
