...
export default {
    ...
    dialog: {
        ...
        dialog_save: { buttonLabel: 'Сохранить', name: 'SAVE files', title: 'Save File' },
    ...
    extra: {
        credits: [
            ...
            [
                ...
                'Zaxento The Greedy',
                '',
                '§fill=#ff0§< ARTIST (CONTINUED) >§fill=#fff§',
                'Abb',
            ...
            [
                ...
                'JustAnimates',
                '§fill=#808080§Improved Toriel sprite art.§fill=#fff§',
                'Kite95',
            ...
            [
                ...
                'Codetoil',
                '§fill=#808080§\"The Great Theoretical Physicist Codetoil.\"§fill=#fff§',
                'Murder--Sans_MDR',
            ...
            [
                '§fill=#ff0§< ПРОГРАММИРОВАНИЕ >§fill=#fff§',
                'ryi3r',
                '§fill=#808080§\"Remember when I speedran the chaotic?\"§fill=#fff§',
                'Wasneet Potato',
                ...
                '§fill=#808080§Adding the entirety of CJK characters into one image... it builds character!§fill=#fff§',
            ],
            [
    ...
    menu: {
        ...
        settings6a: 'БЕГ ПЕРСОНАЖА',
        settings6b: 'ЦВЕТНЫЕ СПРАЙТЫ',
        settings7: 'ЯРКИЕ ВСПЫШКИ',
        settings7a: 'NORMAL',
        settings7b: 'REDUCED',
