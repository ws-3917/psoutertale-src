...
export default {
    a_aerialis: {
        ...
        harpyKILLER: ["<32>{#p/basic}* 天啦噜，我好像快要死啦！\n* 笑鼠了！"],
        ...
        tvm1: ['<32>{#p/human}* （你获得了一台老式收音机。）', '<32>{#p/basic}{#npc/a}* 希望你喜欢你的新收音机！'],
...
'<32>{#z11}* 开始我还很生气。\n* 但死得太多，\n  现在我都看麻木了。',
            ...
            barricadeFail2x: [
                ...
                '<25>{#g/alphysInquisitive}* 你跑别的房间去了？',
            ...
            cooker12: () =>
                SAVE.data.n.state_foundry_undyne > 0
                    ...
                    : [
                        ...
                        '<25>{#g/alphysHellYeah}* 有个一次性的便携飞行器！',
...
'<32>{#p/basic}* 这些光圈能证明，\n  就算老板炒我鱿鱼，\n  我也肯定能复职的...'
                    ...
                    : [
                        ...
                        ...(world.bad_lizard === 1
                            ? [
                                ...
                                "<25>{#g/alphysOhGodNo}* 啊，不是说你会做出\n  什么不好的事！",
                                '<25>{#g/alphysWorried}* 就只是...',
                                "<25>{#g/alphysCutscene2}* 就只是担心要是没有\n  我的帮助，你就可能会陷入\n  什么困境，懂了吗？",
                                '<25>{#g/alphysCutscene2}* ...',
            ...
            opera5b: ['<25>{#p/alphys}{#g/alphysSmileSweat}* 呃，哦！\n  这里好像本来就没守卫。'],
...
'<32>{#x1}* 在压轴好戏上映前，\n  我还得准备一会。',
            ...
            hapsta40: ["<33>{#p/mettaton}{#e/mettaton/11}* 亲爱的，讲话能爽快点吗？\n  我们可没那么多时间。"],
            hapsta41: [
            ...
            hapsta43: ["<32>{#p/finalghost}* 但那就是事实。"],
            hapsta44: ['<32>{#p/mettaton}{#e/mettaton/6}* ...哦，你们幽灵现在是\n  在联手来对付我吗。\n* 真可爱。'],
            ...
            hapsta53: [
                '<32>{#p/mettaton}{#e/mettaton/17}* 哦，你知道个什么！\n* 你真能理解这给我种\n  什么感觉吗？'
            ],
            hapsta54: ["<32>{#p/finalghost}* 我们好歹也算读过你的日记，\n  所以小幽肯定能理解的..."],
            hapsta55a: [
                "<32>{#p/mettaton}{#e/mettaton/19}* 你们读没读日记，根本不重要，\n  我本人什么态度，听我亲口说。",
                '<32>{#p/mettaton}{#e/mettaton/3}* ...',
'<32>{#p/mettaton}{#e/mettaton/3}* 咳咳，我的“表亲”。\n* 问题的根本，从来不在\n  家族企业本身。',
            ...
            opera36a: () => [
                ...
                ...(SAVE.data.b.failshow || !SAVE.data.b.item_tvm_mewmew || SAVE.data.b.mewget
                    ? [
                        ...
                        "<25>{#g/alphysHellYeah}* 我-我会跟你保持联络的！"
                    ]
                    : [
                        ...(!SAVE.storage.inventory.has('tvm_mewmew') && // NO-TRANSLATE
                    ...
                    : [
                        ...
                        ...(world.alphys_percieved_kills < 10
                            ? [
                                ...
                                "<25>{#g/alphysThatSucks}* ...我不知道我还能做什么..."
                            ]
                            : [
                    ...
                    : [
                        ...(SAVE.data.n.state_foundry_undyne === 2
                            ? [
                                ...
                                ...(world.alphys_percieved_kills < 10
                                    ? [
                                        '<25>{#p/alphys}{#g/alphysSmileSweat}* 尽管她对你有点无情...',
                                ...
                                '<25>{#p/alphys}{#g/alphysNeutralSweat}* 让我满怀希望的... 也是她。',
                                '<25>{#p/alphys}{#g/alphysThatSucks}\n* 我就这么眼睁睁看着你...\n  轻而易举地杀了她，\n  感觉就像...',
                                '<25>{#p/alphys}{#g/alphysIDK2}* ...就像重拾的希望\n  在眼前又瞬间破灭...',
                                '<25>{#p/alphys}{#g/alphysIDK2}* 变成满天的碎片...',
                                '<25>{#p/alphys}{#g/alphysIDK3}* ...荡然无存。',
                    ...
                    ? [
                        ...
                        ...(world.postnoot
                            ? world.nootflags.has('undyne') // NO-TRANSLATE
                                ...
                                ? ['<25>{#g/alphysWelp}* ...就算是供气系统发生故障\n  也不会出啥事的。']
                                : ["<25>{#g/alphysInquisitive}* ...就算空气里\n  有种奇怪的味道..."]
                            : [])
                    ]
                    : [
                ...
                SAVE.data.b.svr
                    ? [
                        ...
                        ...[
                            ...
                            [
                                "<26>{#p/asriel1}{#f/17}* 不过一般来说，\n  怪物食物都不需要\n  装在盘子里。",
                                '<25>{#f/20}* 除非盘子也是食物...',
                                "<25>{#f/17}* 但我觉得你大概习惯了。"
                            ],
                            ['<25>{#p/asriel1}{#f/4}* 幸好那个烂节目\n  没有演出过。']
                                                ...
                                                : SAVE.data.n.plot < 60
                                                    ...
                                                    : SAVE.data.n.plot < 61
                                                        ? SAVE.data.b.a_state_moneyitemC
                                                            ? ['<25>{#p/alphys}{#g/alphysFR}* ...', '<25>{#g/alphysFR}* 你一定也会注意的。­']
                                                            : [
                                                                '<25>{#p/alphys}{#g/alphysCutscene3}* ...',
                                                                '<25>* 如今镁塔顿做事\n  越来越不计后果了。'
                                                            ]
                ...
                () =>
                    SAVE.data.b.svr
                        ...
                        : [
                            ...
                            '<32>* “你看，地球上的人们，\n   喜欢在生活中添加一些趣味。”',
                            '<32>* “你总不能造个金属盒子\n   就收工吧，\n   明白我的意思吗？”',
                            '<32>* “你必须赋予它风格和\n   令人眼花缭乱、充满活力的功能，\n   譬如，投{@fill=#ff0}机{@fill=#fff}倒{@fill=#ff0}把{@fill=#fff}！”',
                            '<32>* “另外，为了最大限度地吸引别人，\n   可以用它的机动性做一些\n   有创意的事情！”',
                            '<32>* “譬如，呃... 独轮车那种？”\n* “反正就，类似那样的。”',
                            '<32>{#p/human}* （你把书放回了书架。）'
                        ],
            ...
            cream_bucket: () =>
                SAVE.data.b.svr
                    ? [
                        ...
                        ...[
                            [
                                "<25>{#p/asriel1}{#f/15}* 呃，别把那玩意\n  弄我身上就行。",
                                '<25>{#p/asriel1}{#f/15}* 要是沾上了这玩意，\n  我就只能疯狂地抖动身体把\n  它从我的毛发上给甩下来。',
'<25>{#p/asriel1}{#f/15}* 就跟一条小狗似的...'
                            ],
                            ['<25>{#p/asriel1}{#f/8}* ...', "<26>{#p/asriel1}{#f/31}* ...我知道你想干嘛，\n  打住。"],
                            ['<25>{#p/asriel1}{#f/31}* ...']
...
'<32>{#p/human}* （...无事发生。）']
        ...
        npc: {
            ...
            a_slime_kid1: pager.create(
                ...
                () =>
                    SAVE.data.n.plot === 72
                        ? ["<32>{#p/basic}{#npc/a}* 我们现在来玩“怪物...", '<32>* ...与怪物”的游戏。']
                                ...
                                : SAVE.data.b.killed_mettaton
                                    ...
                                    : [
                                        iFancyYourVilliany()
                                            ...
                                            : "<32>{#p/basic}{#npc/a}* 嘿，你是那个在镁塔顿的节目中\n  击败他的人类！",
                                        '<32>* 表演超精彩的！'
                                    ],
                () =>
                    SAVE.data.n.plot === 72
    ...
    b_opponent_madjick: {
        ...
        status1: () =>
            !world.badder_lizard ? ['<32>{#p/alphys}* 坏了。'] : ['<32>{#p/story}* 谜宇人在刹那间突然现身！'],
        act_check: () =>
            !world.badder_lizard
    ...
    b_opponent_froggitex: {
        ...
        mercyStatus: () =>
            !world.badder_lizard
                ...
                : ['<32>{#p/story}* 终极蛙吉特似乎\n  不愿意和你战斗了。'],
        act_mystify: ['<32>{#p/human}* （你装神弄鬼，故弄玄虚，\n  但终极蛙吉特没被你骗住。）'],
        act_threaten: ['<32>{#p/human}* （你装腔作势，威胁终极蛙吉特，\n  但它没被你唬住。）'],
        perilStatus: () =>
            !world.badder_lizard
                ? calm_lizard()
                    ? ['<32>{#p/alphys}* 呃...']
    ...
    b_opponent_tsundere: {
        ...
        act_ignore: ["<32>{#p/human}* （你故意无视了傲娇飞船的存在。）"],
                ...
                ? [
                    ...
                    ...((fetchCharacters()
                        ...
                        ? [
                            ...
                            '<25>{#p/alphys}{#g/alphysUhButHeresTheDeal}* 你就非要拿是吧！'
                        ]
                        : [])
                ]
                : ['<32>{#p/human}* （你喝掉了橙汁汽水。）']
