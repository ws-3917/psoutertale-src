...
export default {
    a_foundry: {
        ...
        blookdate8x: ['<32>{#p/napstablook}* 嗯，还挺快的...', '<32>* 尽管如此，\n  还是谢谢你愿意尝试...'],
        blookdate8y: ['<32>{#p/napstablook}* 就这样吧', '<32>* ............'],
        blookdate9: [
            ...
            f_echo6: () =>
                world.runaway
                    ...
                    : SAVE.data.n.plot === 72
                        ? [
                            '<32>{#s/echostart}{#p/event}{#npc/a}* 讯号开始...',
                            "<32>{#p/basic}* 我也许会想念这地方的。",
                            '<32>{#p/basic}* 我们在这里\n  真的产生了归属感。',
                            "<32>{#p/basic}* （开玩笑吧？）\n* （我一秒也不想待在这了。）",
                            "<32>{#p/basic}* （我在这过得并不怎么样。）",
                            '<32>{#s/echostop}{#p/event}{#npc}* 讯号终止。'
                        ]
                        : geno()
                            ? [
            ...
            f_starkiller: pager.create(
                ...
                () =>
                    SAVE.data.n.plot === 72
                        ...
                        : SAVE.data.n.state_foundry_undyne !== 0
                            ? ['<32>{#p/basic}{#npc/a}* 我觉得草已经褪色了。', "<32>* 你不觉得吗...？"]
...
'<32>* 现在给老子爬！'
            ...
            f_village_sign1: () =>
                SAVE.data.b.svr
                    ? ['<32>{#p/human}* （牌子对你的到来表示欢迎。）']
                    : ['<32>{#p/tem}* “你吼！！”\n* “欢银来...”\n* “提咪村庄！！！”'],
            f_village_sign2: () =>
                SAVE.data.b.svr
                    ? ['<32>{#p/human}* （牌子想让你看看附近的商店。）']
                    : ['<32>{#p/tem}* “你吼！！”\n* “尼赢改看看...”\n* “提咪商店！！！”'],
            f_village_sign3: () =>
                SAVE.data.b.svr
                    ? ['<32>{#p/human}* （这牌子讲述的\n  内容与旁边的牌子一致。）']
...
'<32>{#p/human}* （呃啊... 好心痛。）',
        ...
        unddate56x: ['<25>{*}{#p/undyne}{#f/8}* 这就对了！！！{^20}{%}'],
            ...
            SAVE.data.n.state_starton_papyrus === 1
                ? SAVE.data.n.hp < 6
                    ? [
                        ...
                        "<20>{#p/undyne}{#e/undyne/2}你当时怎么没好好想想？"
                    ]
                    : SAVE.data.n.hp < 11
                        ? [
