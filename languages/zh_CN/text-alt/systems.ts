    ...
    extra: {
        credits: [
            ...
            [
                ...
                'Zaxento The Greedy',
                '',
                '§fill=#ff0§< 美工（上色+边框） >§fill=#fff§',
                '凝雨白沙',
                '§fill=#808080§贡献了一张边框、一张域外同人图\n以及一些酷炫的上色像素图。§fill=#fff§',
                'C-G_O_A_T（夕三羊）',
                '§fill=#808080§贡献了艾菲斯、艾斯利尔、安黛因\n等角色的上色像素贴图。§fill=#fff§',
            ],
            [
                '§fill=#ff0§< 美工（上色+边框） >§fill=#fff§',
                'DarkFlameWeaver',
                '§fill=#808080§贡献了一套\n安黛因战斗上色贴图。§fill=#fff§',
                'JustAnimates',
                '§fill=#808080§协助优化托丽尔上色贴图。§fill=#fff§',
                '这是纸鸢',
                '§fill=#808080§制作全套弗里斯克跑步动画，并协助优化\n许多重要角色的上色贴图。§fill=#fff§',
                'KodLenss',
