...
'<32>{#p/mettaton}{#e/mettaton/16}* 唯一就是偶尔问一句\n  “嘿，你啥时候回来工作？”',
            ...
            hapsta73: ['<32>{#p/finalghost}* Blooky，这算个不错的尝试了。', '<32>{#p/finalghost}* 嗯，不错的尝试。'],
...
'<32>{#p/human}* （...无事发生。）']
    ...
    b_opponent_froggitex: {
        ...
        act_threaten: ['<32>{#p/human}* （你装腔作势，威胁Final Froggit，\n  但它没被你唬住。）'],
        perilStatus: () =>
            !world.badder_lizard
                ? calm_lizard()
                    ? ['<32>{#p/alphys}* 呃...']
