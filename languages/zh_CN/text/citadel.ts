            ...
            tvfish: pager.create(
                ...
                () =>
                    player.face !== 'up' // NO-TRANSLATE
                        ...
                        ? []
                        : [
                            '<25>{#p/undyne}{#f/14}{#npc/a}* 跟休闲回廊的姑娘们\n  一块淘垃圾的时候，\n  发现了这部电影。',
        ...
        story: {
            ...
            asgoreStoryPre1: () =>
                world.bad_robot
                    ...
                    : ["<25>{#p/asgore}{#f/0}* ...是不是挺美的？", '<25>{#p/asgore}{#f/0}* ...'],
            asgoreStoryPre2: () =>
                world.bad_robot
...
'<25>{#f/0}* 如果说升一级，通一窍，\n  那你应该完全开窍了。',
            ...
            clover1: ["<32>{#p/human}{#v/6}{@fill=#faff29}* ...是不是挺美的？"],
            clover2: [
            ...
            sad4a: () => [
                ...(world.runaway
                    ...
                    : [
                        ...
                        '<25>{#f/17}* ...拜托，Frisk。',
                        "<25>{#f/23}* 你...\n* 你又要把我弄哭了。",
                        ...(SAVE.data.b.oops ? [] : ['<32>{#p/basic}* ...我-我理解...']),
                ...
                SAVE.data.b.svr
                    ? [
                        ...
                        ...[
                            ...
                            ['<25>{#p/asriel1}{#f/19}* ...', '<25>* 我居然没想过为啥他们的\n  衣服都放在里面被这样\n  妥善保管着。'],
                            [
