    ...
    SAVE.data.n.plot < 49
        ...
        : SAVE.data.n.plot < 51
            ? world.bad_lizard > 1 || SAVE.data.n.state_foundry_undyne === 2
                ? [
                    '<25>{#p/toriel}{#f/1}* 等我当上老师...',
                    '<25>{#f/0}* 说不定可以带学生\n  去皇家实验室参观。',
                    "<25>{#f/0}* 当然了，得Alphys博士\n  同意才行。",
                    '<25>{#f/1}* 科学员们肯定在那\n  做了不少有趣的的实验...',
                    "<25>{#f/0}* 对孩子们来说，这可是\n  难得的学习机会啊。"
                ]
                : [
                    '<25>{#p/toriel}{#f/0}* 小家伙，听说你上电视了！\n* 这事传得可快啦！',
                    '<25>{#f/0}* 可惜家里没电视，\n  我没能看到你的表演。',
...
export default {
    a_outlands: {
        ...
        finaltext: {
            ...
            d31: ["<32>{#p/basic}* ...是你，Asriel。", "<32>* 正因为有你，我才有\n  让自己活下去的目标。"],
            d32: [
                '<32>{#p/basic}* 我先前大概以为...\n  是你害得我们没有实现承诺。',
                '<32>* 我便怀恨在心...\n  恨你当时没有和我一起攻击...',
                "<32>* 最后却发现，错的是我。\n  当时，我本该在意你的感受，\n  却把这点抛之脑后。",
...
'<25>{#f/16}* 而赢家通常是不会愿意\n  继续和输家“玩”的。'
        ...
        runaway1: [
            ['<25>{#p/toriel}{#f/1}* 为啥不回屋里玩呢？', '<25>{#f/0}* 来吧。'],
            ...
            ['<25>{#p/toriel}{#f/4}* ...'],
            ['<25>{#p/toriel}{#f/17}* ...', '<25>{#f/15}* 别闹了，我要生气了。'],
            ['<25>{#p/toriel}{#f/17}* ...']
        ],
        runaway2: [
...
'<25>{#f/11}* 这次大概会容易点吧？\n  ...不过谁说得准呢？',
    ...
    b_opponent_napstablook: {
        ...
        consoleTalk3: ["<11>{#p/napstablook}{~}你并非真心\n抱歉..."],
        deadTalk: [
    ...
    c_call_toriel: <Partial<CosmosKeyed<CosmosProvider<string[]>, string>>>{
        ...
        w_candy: () => [
            SAVE.data.n.state_wastelands_candy < 4
                ? '<25>{#p/toriel}{#f/1}* 那台机器还没坏吗？'
                : '<25>{#p/toriel}{#f/1}* 天啊，那台机器又坏了吗？',
            '<25>{#f/5}* 哎，我都数不清\n  我修了这玩意多少次了。',
            '<25>{#f/3}* 不过往好处想，\n  它这样确实省电了...',
            '<25>{#f/0}* ...也算是有利有弊吧。'
        ],
