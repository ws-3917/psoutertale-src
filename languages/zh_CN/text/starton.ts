...
'<18>因为我，\n伟大的PAPYRUS...',
    ...
    b_opponent_lesserdog: {
        ...
        status6: () =>
            world.goatbro ? ['<32>{#p/asriel2}* Canis Minor。'] : ['<32>{#p/story}* Canis Minor有点兴奋过头了。'],
        status7: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* Canis Minor。']
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        "<18>{#p/papyrus}{#f/6}还是\n皇室的亲信！",
                        "<25>{#p/undyne}{#f/12}* 是啊...\n  按理说就是这样。",
                        "<25>{#p/undyne}{#f/16}* 但自从Roman教授去世后，\n  我们每个人的心中\n  都还没做好替代他的准备。",
