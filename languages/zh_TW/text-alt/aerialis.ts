...
'<32>{#p/human}* （...無事發生。）']
                                ...
                                : SAVE.data.b.killed_mettaton
                                    ...
                                    : [
                                        iFancyYourVilliany()
                                            ...
                                            : "<32>{#p/basic}{#npc/a}* 嘿，你是那個在鎂塔頓的節目中\n  擊敗他的人類！",
                                        '<32>* 表演超精彩的！'
                                    ],
                () =>
                    SAVE.data.n.plot === 72
    ...
    b_opponent_madjick: {
        ...
        status1: () =>
            !world.badder_lizard ? ['<32>{#p/alphys}* 壞了。'] : ['<32>{#p/story}* 謎宇人在剎那間突然現身！'],
        act_check: () =>
            !world.badder_lizard
    ...
    b_opponent_froggitex: {
        ...
        act_threaten: ['<32>{#p/human}* （你裝腔作勢，威脅終極蛙吉特，\n  但它沒被你唬住。）'],
        perilStatus: () =>
            !world.badder_lizard
                ? calm_lizard()
                    ? ['<32>{#p/alphys}* 呃...']
    ...
    b_opponent_tsundere: {
        ...
        act_ignore: ["<32>{#p/human}* （你故意無視了傲嬌飛船的存在。）"],
