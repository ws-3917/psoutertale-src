...
export default {
    a_foundry: {
        ...
        blookdate8x: ['<32>{#p/napstablook}* 嗯，還挺快的...', '<32>* 儘管如此，\n  還是謝謝你願意嘗試...'],
        blookdate8y: ['<32>{#p/napstablook}* 就這樣吧', '<32>* ............'],
        blookdate9: [
            ...
            f_echo6: () =>
                world.runaway
                    ...
                    : SAVE.data.n.plot === 72
                        ? [
                            '<32>{#s/echostart}{#p/event}{#npc/a}* 訊號開始...',
                            "<32>{#p/basic}* 我也許會想念這地方的。",
                            '<32>{#p/basic}* 我們在這裡\n  真的產生了歸屬感。',
                            "<32>{#p/basic}* （開玩笑吧？）\n* （我一秒也不想待在這了。）",
                            "<32>{#p/basic}* （我在這過得並不怎麼樣。）",
                            '<32>{#s/echostop}{#p/event}{#npc}* 訊號終止。'
                        ]
                        : geno()
                            ? [
            ...
            f_starkiller: pager.create(
                ...
                () =>
                    SAVE.data.n.plot === 72
                        ...
                        : SAVE.data.n.state_foundry_undyne !== 0
                            ? ['<32>{#p/basic}{#npc/a}* 我覺得草已經褪色了。', "<32>* 你不覺得嗎...？"]
...
'<32>* 現在給老子爬！'
            ...
            f_village_sign1: () =>
                SAVE.data.b.svr
                    ? ['<32>{#p/human}* （牌子對你的到來表示歡迎。）']
                    : ['<32>{#p/tem}* 「你吼！！」\n* 「歡銀來...」\n* 「提咪村莊！！！」'],
            f_village_sign2: () =>
                SAVE.data.b.svr
                    ? ['<32>{#p/human}* （牌子想讓你看看附近的商店。）']
                    : ['<32>{#p/tem}* 「你吼！！」\n* 「尼贏改看看...」\n* 「提咪商店！！！」'],
            f_village_sign3: () =>
                SAVE.data.b.svr
                    ? ['<32>{#p/human}* （這牌子講述的\n  內容與旁邊的牌子一致。）']
...
'<32>{#p/human}* （呃啊... 好心痛。）',
        ...
        unddate56x: ['<25>{*}{#p/undyne}{#f/8}* 這就對了！！！{^20}{%}'],
