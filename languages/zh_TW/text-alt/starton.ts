                ...
                postSIGMA()
                    ...
                    : [
                        ...
                        SAVE.data.b.svr
                            ? '<32>{#p/human}* （你走向了電腦...）'
                            : "<32>{#p/basic}* 電腦的瀏覽器\n  打開了一個\n  社交媒體網站。",
                        choicer.create("* （登入帕派瑞斯的帳戶嗎？）", '登入', '算了')
                    ],
            () =>
                postSIGMA()
                    ? ["<32>{#p/basic}* 不能使用了。"]
...
'<18>因為我，\n偉大的帕派瑞斯...',
    ...
    b_opponent_lesserdog: {
        ...
        status6: () =>
            world.goatbro ? ['<32>{#p/asriel2}* 小犬座。'] : ['<32>{#p/story}* 小犬座有點興奮過頭了。'],
        status7: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 小犬座。']
                : ['<32>{#p/story}* 小犬座看樣子\n  根本停不下來。'],
    ...
    n_shop_blook: {
        exit: ["<32>{#p/napstablook}{#k/0}* 喔... 要走了嗎...", '<32>{#k/1}* 好吧，下次再見，也許吧...'],
        item: () =>
            blookGone()
                ? [
                    '§fill=#808080§---- 售罄 ----',
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        '<18>{#p/papyrus}{#f/6}對對對，就是這樣！！',
                        "<25>{#p/undyne}{#f/16}* 畢竟你倆是親兄弟...",
...
'<25>{#p/undyne}{#f/12}* 所以這麼搞可能會弄巧成拙。',
                        '<18>{#p/papyrus}{#f/5}那玩意\n已經「完美」了？',
                        '<18>{#p/papyrus}{#f/6}可你之前不是說過\n沒有最好，只有更好嗎！',
                        '<25>{|}{#p/undyne}{#f/17}* 呃... 是這樣沒錯啦！\n* 我其實想說- {%}',
                        '<18>{#p/papyrus}幾乎完美。\n這樣說可以吧。',
                        '<25>{#p/undyne}{#f/12}* 對對對，就是這個。'
                    ])
            ],
            () =>
                solo()
                    ? [
                        "<18>{#p/papyrus}{#f/4}要是衫斯能找到點\n好建材，就好了。",
        ...
        s_doggo: pager.create(
            ...
            () => [
                ...
                ...(solo()
                    ? []
                    : [
                        '<25>{#p/undyne}{#f/16}* 是啊，我還記得這件事呢...',
                        '<25>{#p/undyne}{#f/22}* 他...\n* 他當時還在想...',
                        '<18>{#p/papyrus}{#f/5}...嗯？',
                        '<25>{#p/undyne}{#f/9}* ...幸好有你在。',
                        "<25>{#p/undyne}{#f/16}* 不然他說不定就...",
                        '<18>{#p/papyrus}{#f/6}啥？\n說不定就怎樣？？',
                        '<25>{#p/undyne}{#f/12}* ...呃，他說不定就馬上離隊了。',
                        '<18>{#p/papyrus}{#f/0}喔，這樣啊。',
                        '<18>{#p/papyrus}{#f/5}那可就太可惜了...'
                    ])
            ],
            () =>
                solo()
                    ? ['<18>{#p/papyrus}{#f/0}善良的確是種美德啊！']
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        '<18>{#p/papyrus}{#f/5}真是悲劇啊...',
                        "<25>{#p/undyne}{#f/17}* 但是，嘿！\n* 也沒那麼糟！！",
                        '<25>{#p/undyne}{#f/14}* 畢竟，你可以把它們的晶片\n  轉移到一臺新電腦上。',
                        '<18>{#p/papyrus}{#f/0}喔！喔！\n我大概懂了！',
                        "<18>{#p/papyrus}{#f/0}這樣它們就可以\n上域外網了！",
                        '<18>{#p/papyrus}{#f/0}還有天文觀測網路！',
...
'<18>{#p/papyrus}{#f/0}向世人證明\n我高超的廚藝...',
        ...
        s_puzzle1: pager.create(
            ...
            () =>
                solo()
                    ? ["<18>{#p/papyrus}{#f/4}我正解這個謎題呢..."]
                    : [
                        '<18>{#p/papyrus}{#f/5}嗯...',
                        '<18>{#p/papyrus}{#f/0}安黛因真該關注一下\n望遠鏡的行情。',
                        '<18>{#p/papyrus}{#f/4}聽說，我兄弟\n現在正在搞\n免費入會的活動呢...'
                    ]
        ),
...
'<18>{#p/papyrus}{#f/0}再接再厲！',
            ...
            () =>
                solo()
                    ...
                    : [
                        ...
                        '<18>{#p/papyrus}{#f/5}我認真的。',
                        '<18>{#p/papyrus}{#f/4}糟透了。',
                        '<25>{#p/undyne}{#f/11}* ...好吧，\n  聽你的...'
                    ],
            () => (solo() ? ['<18>{#p/papyrus}{#f/4}...'] : ['<25>{#p/undyne}{#f/7}* 他都讓你別提這個了！！'])
        ),
        s_greater: pager.create(
            0,
            () => [
                '<18>{#p/papyrus}這不是大犬座的\n哨站嘛...',
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        '<18>{#p/papyrus}{#f/6}...塔們也架不住\n這樣折騰啊！',
                        "<25>{#p/undyne}{#f/12}* ...幸好，咱\n  有個超棒的人類\n  來挪這些塔架！",
                        '<18>{#p/papyrus}{#f/0}這回我【總算】\n不用親自出馬了。'
                    ])
            ],
            () =>
                solo()
        ...
        f_tunnel: pager.create(
            0,
            () => [
                '<18>{#p/papyrus}{#f/0}啊... 你在垃圾場啊。',
                '<18>{#p/papyrus}{#f/0}人們有東西不想要了\n就丟那，可方便了。',
                '<18>{#p/papyrus}{#f/4}其實...',
                '<18>{#p/papyrus}{#f/9}你要是想免費尋寶就去那，\n也挺方便！',
                ...(solo()
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        "<25>{#p/undyne}{#f/7}* 靜電的危害，我能不知道？！",
                        '<18>{#p/papyrus}{#f/4}...那你還去抓人類幹嘛。',
                        '<25>{#p/undyne}{#f/1}* 不敢直面危險，\n  哪還配叫皇家守衛？',
                        "<18>{#p/papyrus}{#f/6}直面危險\n也不是讓你玩命啊？？",
                        '<25>{#p/undyne}{#f/12}* 俗話說的好：「富貴險中求。」',
                        "<18>{#p/papyrus}{#f/7}遇到危險，富貴算個球！！"
                    ])
            ],
            () =>
                solo()
            ...
            () =>
                SAVE.data.n.plot <= 48.1 && SAVE.data.n.state_foundry_blookdate < 2
                    ...
                    : solo()
                        ...
                        : ['<18>{#p/papyrus}{#f/0}有描寫私語的兒童的，\n有能讓你死於耳聾的。', '<25>{#p/undyne}{#f/8}* 真的有很多音樂！！']
        ),
        ...
        a_path4: pager.create(
            ...
            () => [
                ...
                '<18>{#p/papyrus}{#f/4}一個吃\n太空鮪魚的地方...',
                '<18>{#p/papyrus}{#f/5}嗯，放那的東西\n就那麼直接消失了。',
                ...(solo()
                    ? ['<18>{#p/papyrus}{#f/6}你知道這樣的地方嗎？']
                    : [
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        '<18>{#p/papyrus}{#f/4}哈？\n你是不是以為...',
                        '<18>{#p/papyrus}{#f/7}...我們倆之間有啥\n特殊關係吧！？！？',
                        '<25>{#p/undyne}{#f/14}* 才怪，\n  怎麼可能。',
                        "<25>{#p/undyne}{#f/17}* 不過這也太明顯了，\n  我都忍不住把真相\n  說出來了。",
                        '<18>{#p/papyrus}{#f/5}（唉...）'
                    ])
            ],
            () =>
                solo()
                    ? SAVE.data.n.plot < 60
                        ? ['<18>{#p/papyrus}{#f/0}幸好我找了個替身。']
                        : SAVE.data.b.undyne_respecc
                            ? ['<18>{#p/papyrus}{#f/0}謝天謝地，\n安黛因幫我\n參加了節目。']
                            : ['<18>{#p/papyrus}{#f/0}謝天謝地，\n我兄弟幫我\n參加了節目。']
                    : ['<25>{#p/undyne}{#f/12}* 帕派瑞斯正白日做夢，\n  沒空接電話。']
        ),
        a_rg2: pager.create(
            0,
            () => [
                '<18>{#p/papyrus}{#f/6}小心點，人類！',
                '<18>{#p/papyrus}{#f/5}這區域的守衛\n剛剛結束了訓練。',
                "<18>{#p/papyrus}{#f/6}她們也許會忽略\n一些皇家備忘錄！",
                ...(solo()
                    ? ["<18>{#p/papyrus}{#f/0}順便問下，\n啥是皇家備忘錄？"]
                    : [
                        '<25>{#p/undyne}{#f/16}* 對這事我深有體會...',
                        '<18>{#p/papyrus}{#f/5}哈？\n她們經常忽略你的\n備忘錄嗎？',
                        '<25>{#p/undyne}{#f/14}* 喔，\n  那倒不會。',
                        "<25>{#p/undyne}{#f/10}* 不過她們倒是經常會忽略\n  艾菲斯的備忘錄。",
                        "<18>{#p/papyrus}{#f/6}但她可是\n皇家科學員啊！",
                        "<18>{#p/papyrus}{#f/6}還是\n皇室的親信！",
                        "<25>{#p/undyne}{#f/12}* 是啊...\n  按理說就是這樣。",
                        "<25>{#p/undyne}{#f/16}* 但自從羅曼教授去世後，\n  我們每個人的心中\n  都還沒做好替代他的準備。",
                        "<26>{#p/undyne}{#f/10}* 因此皇家衛隊的大多數人\n  都不把他的繼任者\n  當回事，所以..",
                        '<25>{#p/undyne}{#f/9}* 這也影響了\n  實習守衛對她的看法。',
                        '<18>{#p/papyrus}{#f/5}喔...',
                        "<25>{#p/undyne}{#f/17}* 我知道的。\n* 這確實... 不怎麼樣。",
                        "<26>{#f/9}* 但她太笨了，\n  還不能徹底地\n  證明自己。",
                        '<26>{#f/16}* 所以...\n  我大概能理解。',
                        "<18>{#p/papyrus}{#f/5}希望她終將\n得到應有的尊重。",
        ...
        a_barricade2: pager.create(
            0,
            () => [
                "<18>{#p/papyrus}{#f/0}對這個房間，\n我沒啥要說的。",
                '<18>{#p/papyrus}{#f/5}實際上，\n我唯一要說的是...',
                '<18>{#p/papyrus}{#f/6}...是我\n【無】話可說！',
                ...(solo()
                    ? ['<18>{#p/papyrus}{#f/0}額，實際上，\n我還是有話可說的。']
                    : [
                        '<26>{#p/undyne}{#f/1}* 我有句話要說。',
                        '<18>{#p/papyrus}{#f/6}啥？\n是什麼？',
                        '<26>{#p/undyne}{#f/14}* 這個房間可能有\n  也可能沒有路障。',
                        "<18>{#p/papyrus}{#f/4}在一層已經有\n一個這樣的房間了。",
                        '<18>{#p/papyrus}{#f/7}說點原創的！！',
                        "<26>{#p/undyne}{#f/17}* 說不出來了。",
                        '<18>{#p/papyrus}{#f/5}... 沒關係...'
                    ])
            ],
            () =>
                solo()
                    ? ["<18>{#p/papyrus}{#f/0}也許在另一個房間\n我就有話說了。"]
                    : ["<18>{#p/papyrus}{#f/0}也許這個房間\n不是很有趣。"]
        ),
        a_split: pager.create(
            0,
            () => [
                "<18>{#p/papyrus}{#f/0}看，那是著名的\n鎂塔頓噴泉！",
                '<18>{#p/papyrus}{#f/4}我聽說這費了\n九牛二虎之力\n才修建好。',
                '<18>{#p/papyrus}{#f/5}無數個日夜\n刻苦耐勞，\n兢兢業業...',
                '<18>{#p/papyrus}{#f/6}才得到那麼\n完美無瑕的\n長方形。',
                ...(solo()
                    ? []
                    : [
                        '<25>{#p/undyne}{#f/12}* 然後他毀了它，\n  這樣就可以自己設計了。',
                        '<18>{#p/papyrus}{#f/6}真的嗎？？',
                        '<25>{#p/undyne}{#f/1}* 第一個沒有達到\n  他的「高標準」。',
                        '<18>{#p/papyrus}{#f/4}等等，\n電視上有關於\n這個的訊息。',
                        '<25>{#p/undyne}{#f/14}* 喔對，他決定向\n  全前哨站直播。',
                        '<25>{#p/undyne}{#f/17}* 他必須向每個人展示\n  他那所謂的出類拔萃。',
                        '<18>{#p/papyrus}{#f/4}嗯，畢竟這是\n【他的】雕像...'
                    ])
            ],
            () =>
                solo()
                    ...
                    : [
                        '<18>{#p/papyrus}{#f/5}我想知道他為啥\n第一次要\n僱別人設計。',
                        "<18>{#p/papyrus}{#f/4}要是我最開始\n就自己做了..."
                    ]
        ),
        a_offshoot1: pager.create(
            0,
            () => [
                '<18>{#p/papyrus}{#f/5}訊號似乎不太好。',
                "<18>{#p/papyrus}{#f/6}就像是...\n被幹擾了？？",
                "<18>{#p/papyrus}{#f/4}也許最好在\n其他地方打電話。",
                ...(solo()
                    ? []
                    : [
                        "<25>{#p/undyne}{#f/14}* 也許人類在空境的\n  舊瞭望塔附近。",
                        "<25>{#p/undyne}{#f/17}* 他們過去\n  用的金屬有點問題。"
                    ])
            ],
            () =>
                solo()
                    ? ['<18>{#p/papyrus}{#f/4}上一通電話\n沒有打過去嗎？']
                    : ["<25>{#p/undyne}{#f/14}* 不過沒啥大不了的。"]
        ),
        a_elevator3: pager.create(
            ...
            () => [
                ...
                '<18>{#p/papyrus}{#f/5}然後，\n我有點釋然了...',
                '<18>{#p/papyrus}{#f/4}...因為我發現\n附近沒有一個\n無聊的廣告。',
                ...(solo()
                    ? []
                    : [
                        '<25>{#p/undyne}{#f/17}* 所以你喜歡乘電梯嗎？',
                        '<18>{#p/papyrus}{#f/6}嗯...',
                        '<18>{#p/papyrus}{#f/5}有音樂還好，\n要是沒音樂\n簡直痛苦萬分。',
                        '<18>{#p/papyrus}{#f/4}不過我承認\n它們是必需品。',
                        "<25>{#p/undyne}{#f/1}* 好吧，\n  你該慶幸自己\n  不住在尖塔房子裡。",
                        '<18>{#p/papyrus}{#f/5}為啥？',
                        '<25>{#p/undyne}{#f/17}* 那裡全是電梯。',
                        '<18>{#p/papyrus}{#f/6}不——...！',
                        "<25>{#p/undyne}{#f/7}* 而且它們甚至\n  都沒啥必要。",
                        "<18>{#p/papyrus}{#f/8}不要啊...！",
                        "<25>{#p/undyne}{#f/8}* 最後它們甚至\n  不帶音樂！！！",
                        "<18>{#p/papyrus}{#f/1}簡直像是地獄！"
                    ])
            ],
            () =>
                solo()
                    ? [
                        ...
                        '<18>{#p/papyrus}{#f/0}...喔，等等，\n絕對有！',
                        '<18>{#p/papyrus}{#f/9}升降機！！！'
                    ]
                    : [
                        '<18>{#p/papyrus}{#f/5}沒有音樂的電梯\n就像...',
                        '<18>{#p/papyrus}{#f/5}一盤不加番茄醬的\n義大利麵。',
                        '<18>{#p/papyrus}{#f/4}如果是我兄弟那就是\n奶油奶酪醬。',
                        "<18>{#p/papyrus}{#f/4}...而且人們總是說\n我很奇怪。"
                    ]
        ),
        a_elevator4: pager.create(
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        '<18>{#p/papyrus}{#f/5}反正印象不咋樣。',
                        '<25>{#p/undyne}{#f/14}* 這就叫「無知者無畏」吧？',
            ...
            () =>
                solo()
                    ? ["<18>{#p/papyrus}{#f/6}哎，說來話長啊，\n以後再說這事吧。"]
                    : ["<18>{#p/papyrus}{#f/0}這麼一想，被電也挺好。"]
        ),
        ...
        a_lookout: pager.create(
            ...
            () =>
                solo()
                    ...
                    : ['<18>{#p/papyrus}{#f/5}抱歉。', "<18>{#p/papyrus}{#f/4}我可沒吐槽。"]
        ),
        a_hub3: pager.create(
            0,
            () => [
