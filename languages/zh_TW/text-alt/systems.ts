    ...
    extra: {
        credits: [
            ...
            [
                ...
                'Zaxento The Greedy',
                '',
                '§fill=#ff0§< 美工（上色+邊框） >§fill=#fff§',
                '凝雨白沙',
                '§fill=#808080§貢獻了一張邊框、一張域外同人圖\n以及一些酷炫的上色像素圖。§fill=#fff§',
                'C-G_O_A_T（夕三羊）',
                '§fill=#808080§貢獻了艾菲斯、艾斯利爾、安黛因\n等角色的上色像素貼圖。§fill=#fff§',
            ],
            [
                '§fill=#ff0§< 美工（上色+邊框） >§fill=#fff§',
                'DarkFlameWeaver',
                '§fill=#808080§貢獻了一套\n安黛因戰鬥上色貼圖。§fill=#fff§',
                'JustAnimates',
                '§fill=#808080§協助優化托麗爾上色貼圖。§fill=#fff§',
                '這是紙鳶',
                '§fill=#808080§製作全套弗裡斯克跑步動畫，並協助優化\n許多重要角色的上色貼圖。§fill=#fff§',
                'KodLenss',
