    ...
    a_aerialis: {
        ...
        puzzlenoot1: () => [
            ...
            world.nootflags.has('a_barricade1') // NO-TRANSLATE
                ...
                ? '<25>{#p/alphys}{#g/alphysInquisitive}* 這謎題也自己解開了？'
        ...
        harpyKILLER: ["<32>{#p/basic}* 天啦嚕，我好像快要死啦！\n* 笑鼠了！"],
        ...
        tvm1: ['<32>{#p/human}* （你獲得了一臺老式收音機。）', '<32>{#p/basic}{#npc/a}* 希望你喜歡你的新收音機！'],
...
'<32>{#z11}* 開始我還很生氣。\n* 但死得太多，\n  現在我都看麻木了。',
            ...
            barricadeFail2x: [
                ...
                '<25>{#g/alphysInquisitive}* 你跑別的房間去了？',
                ...
                ...(SAVE.data.b.failshow
                    ...
                    : SAVE.data.b.item_tvm_mewmew &&
                        ...
                        : [
                            ...
                            '<25>* 嗯...',
                            SAVE.data.b.item_tvm_mewmew
                                ? "<25>{#g/alphysUhButHeresTheDeal}* 待會我再和你談談。"
            ...
            cooker7d: [
                "<32>{#p/mettaton}* 等等！不對勁...",
                "<32>{#p/mettaton}* 這壓根就不是MTT牌的\n  {@fill=#003cff}樂樂史萊姆{@fill=#fff}！",
                '<32>{#p/mettaton}* 這...這是{@fill=#f00}塑性炸藥{@fill=#fff}！',
            ...
            cooker12: () =>
                SAVE.data.n.state_foundry_undyne > 0
                    ...
                    : [
                        ...
                        '<25>{#g/alphysHellYeah}* 有個一次性的便攜飛行器！',
...
'<32>{#p/basic}* 這些光圈能證明，\n  就算老闆炒我魷魚，\n  我也肯定能復職的...'
            ...
            hapsta21: ["<32>{#p/basic}* 我們的表親背叛了我們。"],
            hapsta22: [
                '<32>{#p/finalghost}* ...',
                '<32>* 我們的表親確實不擇手段，\n  但他絕不可能\n  幹出「背叛」的事來。',
                '<32>* 我與Blooky早已讀過他的日記，\n  在那時，我才知道...\n  這一切都是我們的錯。'
            ...
            hapsta28: [
                '<32>{#p/napstablook}* 這招果然好使...',
                '<32>{#p/mettaton}* 太好了，親愛的。',
                "<32>* 那，等會再聊！"
            ],
            hapsta29: [
                '<32>{#p/basic}* 我就知道。\n* 我就知道！\n* 我-就-知-道！',
...
'<32>{#p/mettaton}{#e/mettaton/16}* 唯一就是偶爾問一句\n  「嘿，你啥時候回來工作？」',
            ...
            hapsta73: ['<32>{#p/finalghost}* Blooky，這算個不錯的嘗試了。', '<32>{#p/finalghost}* 嗯，不錯的嘗試。'],
                ...
                SAVE.data.b.svr
                    ? [
                        ...
                        ...[
                            ...
                            [
                                "<26>{#p/asriel1}{#f/17}* 不過一般來說，\n  怪物食物都不需要\n  裝在盤子裡。",
                                '<25>{#f/20}* 除非盤子也是食物...',
                                "<25>{#f/17}* 但我覺得你大概習慣了。"
                            ],
                            ['<25>{#p/asriel1}{#f/4}* 幸好那個爛節目\n  沒有演出過。']
                                                ...
                                                : SAVE.data.n.plot < 60
                                                    ...
                                                    : SAVE.data.n.plot < 61
                                                        ? SAVE.data.b.a_state_moneyitemC
                                                            ? ['<25>{#p/alphys}{#g/alphysFR}* ...', '<25>{#g/alphysFR}* 你一定也會注意的。­']
                                                            : [
                                                                '<25>{#p/alphys}{#g/alphysCutscene3}* ...',
                                                                '<25>* 如今Mettaton做事\n  越來越不計後果了。'
                                                            ]
            ...
            cream_bucket: () =>
                SAVE.data.b.svr
                    ? [
                        ...
                        ...[
                            [
                                "<25>{#p/asriel1}{#f/15}* 呃，別把那玩意\n  弄我身上就行。",
                                '<25>{#p/asriel1}{#f/15}* 要是沾上了這玩意，\n  我就只能瘋狂地抖動身體把\n  它從我的毛髮上給甩下來。',
'<25>{#p/asriel1}{#f/15}* 就跟一條小狗似的...'
                            ],
                            ['<25>{#p/asriel1}{#f/8}* ...', "<26>{#p/asriel1}{#f/31}* ...我知道你想幹嘛，\n  打住。"],
                            ['<25>{#p/asriel1}{#f/31}* ...']
...
'<32>{#p/human}* （...無事發生。）']
        ...
        npc: {
            ...
            a_slime_kid1: pager.create(
                ...
                () =>
                    SAVE.data.n.plot === 72
                        ? ["<32>{#p/basic}{#npc/a}* 我們現在來玩「怪物...", '<32>* ...與怪物」的遊戲。']
                                ...
                                : SAVE.data.b.killed_mettaton
                                    ...
                                    : [
                                        iFancyYourVilliany()
                                            ...
                                            : "<32>{#p/basic}{#npc/a}* 嘿，你是那個在Mettaton的節目中\n  擊敗他的人類！",
                                        '<32>* 表演超精彩的！'
                                    ],
                () =>
                    SAVE.data.n.plot === 72
                ...
                SAVE.data.n.plot < 66.2
                    ...
                    : SAVE.data.n.plot < 67
                        ...
                        : [
                            '<32>{#p/event}* 鈴鈴，鈴鈴...',
                            '<25>{#p/alphys}{#g/alphysWelp}* 你想好了？\n  那就前進吧。',
                            "<25>{#g/alphysNeutralSweat}* 你馬上就能出核心了..."
                        ],
                ['<32>{#p/event}* 鈴鈴，鈴鈴...', "<25>{#p/alphys}{#g/alphysWelp}* 有事我聯繫你。"]
                ...
                : SAVE.data.b.assist_madjick
                    ...
                    : !SAVE.data.b.killed_madjick
                        ? [
                            ...
                            "<25>{#g/alphysNeutralSweat}* 希-希望別再出這種事了。",
        ...
        core8a: (nooted: boolean) => [
            ...
            ...(nooted
                ...
                : [
                    "<25>{#g/alphysCutscene3}* 這些謎題嘛...\n  難者不會，會者不難。",
                    "<25>{#g/alphysCutscene2}* 說白了，\n  這玩意就是個...\n  大-大號密碼鎖罷了。",
                    '<25>{#g/alphysWelp}* 撥動開關，升降稜柱。\n  只要讓柱子都升起來，\n  門就開了。'
                ])
        ],
        core8a1: () => ["<25>{#p/alphys}{#g/alphysInquisitive}* ...也許你覺得\n  另一條路更適合你？"],
        ...
        core8c1: [
            '<25>{#p/alphys}{#g/alphysInquisitive}* ...你幹啥呢？',
        ...
        core8c2: (nooted: boolean) =>
            nooted
                ? [
                    ...
                    '<25>{#g/alphysFR}* ...',
                    '<25>{#g/alphysFR}* 這玩意啥時候解開的？'
                ]
                : ['<25>{#p/alphys}{#g/alphysWTF}* 我說你啊。\n* 你還真往另一條路走啊。'],
        core8c3: [
            '<25>{#p/alphys}{#g/alphysWelp}* 這下，兩個開關\n  你就能按個遍了。',
            '<25>{#p/alphys}{#g/alphysCutscene3}* 呵，滿意了吧！'
        ],
        core8c4: ['<25>{#p/alphys}{#g/alphysGarboCenter}* ...', '<25>* ...夠了吧，\n  我可沒那功夫陪你玩。'],
        core9a: () => [
        ...
        core9a1: (nooted: boolean) =>
            nooted
                ? [
                    ...
                    '<25>{#p/alphys}{#g/alphysCutscene3}* 這條... 沒有謎題的路。',
                    '<25>{#p/alphys}{#f/3}* 這兒的謎題\n  難道就沒啟用過嗎?'
                ]
                : [
        ...
        core9b: () =>
            1 <= battler.exp
                ...
                : SAVE.data.b.a_state_nooted1
                    ? [
                        "<25>{#p/alphys}{#g/alphysInquisitive}* 你到底在這裡幹啥？",
            ...
            1 <= battler.exp && corefriendly()
                ...
                : nooted
                    ? [
                        ...
                        "<25>{#p/alphys}{#g/alphysCutscene3}* ...噢，迷題已經解開了啊。",
                        '<25>{#p/alphys}{#f/3}* 這兒的謎題\n  難道就沒啟用過嗎?'
                    ]
        ...
        core10c: ['<25>{#p/alphys}{#g/alphysFR}* 有夠折騰的。'],
    ...
    b_opponent_mettaton1: {
        ...
        old_bomb_talk: ["<20>{#p/mettaton}就像是一臺\n免費的舞臺煙霧機！"],
    ...
    b_opponent_madjick: {
        ...
        status1: () =>
            !world.badder_lizard ? ['<32>{#p/alphys}* 壞了。'] : ['<32>{#p/story}* Cozmo在剎那間突然現身！'],
        act_check: () =>
            !world.badder_lizard
    ...
    b_opponent_froggitex: {
        ...
        act_mystify: ['<32>{#p/human}* （你裝神弄鬼，故弄玄虛，\n  但Final Froggit沒被你騙住。）'],
        act_threaten: ['<32>{#p/human}* （你裝腔作勢，威脅Final Froggit，\n  但它沒被你唬住。）'],
        perilStatus: () =>
            !world.badder_lizard
                ? calm_lizard()
                    ? ['<32>{#p/alphys}* 呃...']
    ...
    b_opponent_tsundere: {
        ...
        act_ignore: ["<32>{#p/human}* （你故意無視了Tsunderidex的存在。）"],
