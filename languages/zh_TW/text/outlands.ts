...
export default {
    a_outlands: {
        ...
        finaltext: {
            ...
            d31: ["<32>{#p/basic}* ...是你，Asriel。", "<32>* 正因為有你，我才有\n  讓自己活下去的目標。"],
            d32: [
                '<32>{#p/basic}* 我先前大概以為...\n  是你害得我們沒有實現承諾。',
                '<32>* 我便懷恨在心...\n  恨你當時沒有和我一起攻擊...',
                "<32>* 最後卻發現，錯的是我。\n  當時，我本該在意你的感受，\n  卻把這點拋之腦後。",
...
'<25>{#f/16}* 而贏家通常是不會願意\n  繼續和輸家「玩」的。'
        ...
        runaway1: [
            ['<25>{#p/toriel}{#f/1}* 為啥不回屋裡玩呢？', '<25>{#f/0}* 來吧。'],
            ...
            ['<25>{#p/toriel}{#f/4}* ...'],
            ['<25>{#p/toriel}{#f/17}* ...', '<25>{#f/15}* 別鬧了，我要生氣了。'],
            ['<25>{#p/toriel}{#f/17}* ...']
        ],
        runaway2: [
...
'<25>{#f/11}* 這次大概會容易點吧？\n  ...不過誰說得準呢？',
    ...
    b_opponent_napstablook: {
        ...
        consoleTalk3: ["<11>{#p/napstablook}{~}你並非真心\n抱歉..."],
        deadTalk: [
    ...
    b_opponent_toriel: {
        ...
        status4: ['<32>{#p/story}* Toriel迴避了你的目光。'],
        status5: ['<32>{#p/story}* ...'],
    ...
    c_call_toriel: <Partial<CosmosKeyed<CosmosProvider<string[]>, string>>>{
        ...
        w_candy: () => [
            SAVE.data.n.state_wastelands_candy < 4
                ? '<25>{#p/toriel}{#f/1}* 那臺機器還沒壞嗎？'
                : '<25>{#p/toriel}{#f/1}* 天啊，那臺機器又壞了嗎？',
            '<25>{#f/5}* 哎，我都數不清\n  我修了這玩意多少次了。',
            '<25>{#f/3}* 不過往好處想，\n  它這樣確實省電了...',
            '<25>{#f/0}* ...也算是有利有弊吧。'
        ],
