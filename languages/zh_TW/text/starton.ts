...
'<18>因為我，\n偉大的PAPYRUS...',
    ...
    b_opponent_lesserdog: {
        ...
        status6: () =>
            world.goatbro ? ['<32>{#p/asriel2}* Canis Minor。'] : ['<32>{#p/story}* Canis Minor有點興奮過頭了。'],
        status7: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* Canis Minor。']
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        "<18>{#p/papyrus}{#f/6}還是\n皇室的親信！",
                        "<25>{#p/undyne}{#f/12}* 是啊...\n  按理說就是這樣。",
                        "<25>{#p/undyne}{#f/16}* 但自從Roman教授去世後，\n  我們每個人的心中\n  都還沒做好替代他的準備。",
